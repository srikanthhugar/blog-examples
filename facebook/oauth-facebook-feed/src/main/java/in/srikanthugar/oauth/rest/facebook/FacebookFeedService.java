...
public class FacebookFeedService {
    ...
    private static final String FACEBOOK_RESOURCE_URL = "https://graph.facebook.com/me/feed";

    // Replace these with your own api key, secret and callback url.
    private static final String FACEBOOK_APP_ID = "160167240843883";
    private static final String FACEBOOK_APP_SECRETE = "bb2187b68b3d092c2803b47966e38861";
    private static final String FACEBOOK_CALLBACK_URL = "http://localhost:8080/oauth-facebook-feed/callback";
