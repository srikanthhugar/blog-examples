...
@Path("/")
public class FacebookAboutService {

    private static final String FACEBOOK_RESOURCE_URL = "https://graph.facebook.com/me";

    // Replace these with your own api key, secret and callback url.
    private static final String FACEBOOK_APP_ID = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    private static final String FACEBOOK_APP_SECRETE = "YYYYYYYYYYYYYYYYYYYYYYYY";
    private static final String FACEBOOK_CALLBACK_URL = "http://localhost:8080/oauth-facebook-about/callback";
